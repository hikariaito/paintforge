...
// User ID for future sync — stored in localStorage
let UID="local";
try{let id=localStorage.getItem("pf_uid");if(!id){id="u"+Math.random().toString(36).slice(2);localStorage.setItem("pf_uid",id);}UID=id;}catch(e){}
