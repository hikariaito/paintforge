...
// Supabase sync — loaded dynamically to avoid build issues
...
async function getSB(){
  if(_sb) return _sb;
  try{const {createClient}=await import("@supabase/supabase-js");_sb=createClient(SB_URL,SB_KEY);}catch(e){}
  return _sb;
}
...
class ErrorBoundary extends React.Component {
  ...
  render(){
    if(this.state.error) return(
      <div style={{background:"#0d0d0d",color:"#fff",padding:20,fontFamily:"monospace",fontSize:12,minHeight:"100vh"}}>
        <div style={{color:"#e83030",fontSize:16,marginBottom:10}}>APP ERROR — please report this</div>
