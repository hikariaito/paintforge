...
function BarcodeScanner({allPaints,onFound,onTeach,onClose,onAddNew,addNewMode="shop"}){
  ...
  async function startLiveScan(){
    ...
    setCamError("");
    try{
      // Load ZBar WASM via ES module import
      if(!window._zbarWasm){
        window._zbarWasm=await import("https://cdn.jsdelivr.net/npm/@undecaf/zbar-wasm@0.11.0/dist/index.js");
      }
      const {scanImageData}=window._zbarWasm;
