...
function PaintTrackerApp(){
  ...
  useEffect(()=>{
    async function load(){
      ...
      // Only apply if no local save was triggered while loading
      if(_pendingSave) return;
        ...
        ws.onmessage=e=>{
          try{
            ...
            if(msg.event==="postgres_changes"){
              // Load on any change to shared tables — including from brother's device
              _pendingSave=false; // allow load
              load();
            }
          }catch{}
        };
