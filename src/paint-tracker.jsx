...
const IC = {
  ...
  spray:     <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3l3 3"/><path d="M6 6l9 9"/><rect x="13" y="13" width="8" height="8" rx="2"/><path d="M6 3h3v3H6z"/><circle cx="18" cy="7" r="1" fill="currentColor"/><circle cx="21" cy="4" r="1" fill="currentColor"/><circle cx="21" cy="10" r="1" fill="currentColor"/></svg>,
  flask:     <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 3h6"/><path d="M10 3v7l-4 8h12l-4-8V3"/></svg>,
  ...
  receipt:   <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>,
  masking:   <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="1"/><line x1="9" y1="3" x2="9" y2="21"/><line x1="15" y1="3" x2="15" y2="21"/></svg>,
  primer:    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 2h8"/><path d="M9 2v5l-2 2v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9l-2-2V2"/><line x1="12" y1="12" x2="12" y2="18"/></svg>,
...
const ALL_PAINTS = [
  // ── PRIMARY A ────────────────────────────────────────────────────────────
  { id:"K001", brand:"kaleido", line:"Primary A", name:"White",         hex:"#f2f2f2",  barcode:"8436535950015" },
  { id:"K002", brand:"kaleido", line:"Primary A", name:"Black",         hex:"#0a0a0a",  barcode:"8436535950022" },
  { id:"K003", brand:"kaleido", line:"Primary A", name:"Red",           hex:"#cc1a1a",  barcode:"8436535950039" },
  { id:"K004", brand:"kaleido", line:"Primary A", name:"Orange",        hex:"#e86020",  barcode:"8436535950046" },
  { id:"K005", brand:"kaleido", line:"Primary A", name:"Yellow",        hex:"#f5d000",  barcode:"8436535950053" },
  { id:"K006", brand:"kaleido", line:"Primary A", name:"Green",         hex:"#0d5c2a",  barcode:"8436535950060" },
  { id:"K007", brand:"kaleido", line:"Primary A", name:"Blue",          hex:"#1a2ecc",  barcode:"8436535950077" },
  { id:"K008", brand:"kaleido", line:"Primary A", name:"Purple",        hex:"#4a20a0",  barcode:"8436535950084" },
  { id:"K009", brand:"kaleido", line:"Primary A", name:"Off White",     hex:"#eceae0",  barcode:"8436535950091" },
  { id:"K010", brand:"kaleido", line:"Primary A", name:"Gray",          hex:"#787880",  barcode:"8436535950107" },
  { id:"K011", brand:"kaleido", line:"Primary A", name:"Shine Red",     hex:"#e83018",  barcode:"8436535950114" },
  { id:"K012", brand:"kaleido", line:"Primary A", name:"Orange Yellow", hex:"#e09020",  barcode:"8436535950121" },
  { id:"K013", brand:"kaleido", line:"Primary A", name:"Emerald Green", hex:"#10b850",  barcode:"8436535950138" },
  { id:"K014", brand:"kaleido", line:"Primary A", name:"Cobalt Blue",   hex:"#1a38c0",  barcode:"8436535950145" },
  { id:"K015", brand:"kaleido", line:"Primary A", name:"Violet",        hex:"#6878c0",  barcode:"8436535950152" },
  { id:"K016", brand:"kaleido", line:"Primary A", name:"Pink",          hex:"#e870a0",  barcode:"8436535950169" },
  { id:"K017", brand:"kaleido", line:"Primary A", name:"Russet",        hex:"#a01820",  barcode:"8436535950176" },
  { id:"K018", brand:"kaleido", line:"Primary A", name:"Brown",         hex:"#b04820",  barcode:"8436535950183" },
  { id:"K019", brand:"kaleido", line:"Primary A", name:"Salmon Pink",   hex:"#e84030",  barcode:"8436535950190" },
  { id:"K020", brand:"kaleido", line:"Primary A", name:"Cream Yellow",  hex:"#e0c820",  barcode:"8436535950206" },
  { id:"K021", brand:"kaleido", line:"Primary A", name:"Lime Green",    hex:"#78b860",  barcode:"8436535950213" },
  { id:"K022", brand:"kaleido", line:"Primary A", name:"Dark Green",    hex:"#1a4830",  barcode:"8436535950220" },
  { id:"K023", brand:"kaleido", line:"Primary A", name:"Sky Blue",      hex:"#1898e8",  barcode:"8436535950237" },
  { id:"K024", brand:"kaleido", line:"Primary A", name:"Blue Gray",     hex:"#505870",  barcode:"8436535950244" },
  // ── PRIMARY B ────────────────────────────────────────────────────────────
  { id:"K025", brand:"kaleido", line:"Primary B", name:"Purple Red",    hex:"#b84050",  barcode:"8436535950251" },
  { id:"K026", brand:"kaleido", line:"Primary B", name:"Magenta",       hex:"#e030c0",  barcode:"8436535950268" },
  { id:"K027", brand:"kaleido", line:"Primary B", name:"Ocher",         hex:"#d88820",  barcode:"8436535950275" },
  { id:"K028", brand:"kaleido", line:"Primary B", name:"Ivory",         hex:"#e8e8c8",  barcode:"8436535950282" },
  { id:"K029", brand:"kaleido", line:"Primary B", name:"Yellow Green",  hex:"#44d020",  barcode:"8436535950299" },
  { id:"K030", brand:"kaleido", line:"Primary B", name:"Teal",          hex:"#00c8d8",  barcode:"8436535950305" },
  { id:"K031", brand:"kaleido", line:"Primary B", name:"Ultramarine",   hex:"#1a40c0",  barcode:"8436535950312" },
  { id:"K032", brand:"kaleido", line:"Primary B", name:"Cobalt Violet", hex:"#2050d0",  barcode:"8436535950329" },
  { id:"K033", brand:"kaleido", line:"Primary B", name:"Flesh",         hex:"#e8d8b8",  barcode:"8436535950336" },
  { id:"K034", brand:"kaleido", line:"Primary B", name:"Flesh White",   hex:"#eeeae0",  barcode:"8436535950343" },
  { id:"K035", brand:"kaleido", line:"Primary B", name:"Flesh Pink",    hex:"#e8c0a8",  barcode:"8436535950350" },
  { id:"K036", brand:"kaleido", line:"Primary B", name:"Flesh Orange",  hex:"#e0c878",  barcode:"8436535950367" },
  { id:"K037", brand:"kaleido", line:"Primary B", name:"Matt White",    hex:"#e8ecee",  barcode:"8436535950374" },
  { id:"K038", brand:"kaleido", line:"Primary B", name:"Matt Black",    hex:"#303030",  barcode:"8436535950381" },
  { id:"K039", brand:"kaleido", line:"Primary B", name:"Matt Red",      hex:"#e02828",  barcode:"8436535950398" },
  { id:"K040", brand:"kaleido", line:"Primary B", name:"Matt Orange",   hex:"#e07820",  barcode:"8436535950404" },
  { id:"K041", brand:"kaleido", line:"Primary B", name:"Matt Yellow",   hex:"#e8c800",  barcode:"8436535950411" },
  { id:"K042", brand:"kaleido", line:"Primary B", name:"Matt Green",    hex:"#2a8840",  barcode:"8436535950428" },
  { id:"K043", brand:"kaleido", line:"Primary B", name:"Matt Blue",     hex:"#2060d0",  barcode:"8436535950435" },
  { id:"K044", brand:"kaleido", line:"Primary B", name:"Matt Purple",   hex:"#6655c0",  barcode:"8436535950442" },
  { id:"K045", brand:"kaleido", line:"Primary B", name:"Buff",          hex:"#ddd090",  barcode:"8436535950459" },
  { id:"K046", brand:"kaleido", line:"Primary B", name:"Wood",          hex:"#d4b880",  barcode:"8436535950466" },
  { id:"K047", brand:"kaleido", line:"Primary B", name:"Wood Brown",    hex:"#c09060",  barcode:"8436535950473" },
  { id:"K048", brand:"kaleido", line:"Primary B", name:"Rubber Black",  hex:"#303438",  barcode:"8436535950480" },
  // ── MECHA ─────────────────────────────────────────────────────────────────
  { id:"K101", brand:"kaleido", line:"Mecha", name:"Cool White",        hex:"#eef0f4",  barcode:"8436535951005" },
  { id:"K102", brand:"kaleido", line:"Mecha", name:"Bright Red",        hex:"#e82020",  barcode:"8436535951012" },
  { id:"K103", brand:"kaleido", line:"Mecha", name:"Bright Yellow",     hex:"#e8cc00",  barcode:"8436535951029" },
  { id:"K104", brand:"kaleido", line:"Mecha", name:"Bright Blue",       hex:"#1a50e0",  barcode:"8436535951036" },
  { id:"K105", brand:"kaleido", line:"Mecha", name:"Olive Green",       hex:"#708860",  barcode:"8436535951043" },
  { id:"K106", brand:"kaleido", line:"Mecha", name:"Deep Olive Green",  hex:"#4a6040",  barcode:"8436535951050" },
  { id:"K107", brand:"kaleido", line:"Mecha", name:"Hibiscus Purple",   hex:"#8868cc",  barcode:"8436535951067" },
  { id:"K108", brand:"kaleido", line:"Mecha", name:"Titanium Slate",    hex:"#505a68",  barcode:"8436535951074" },
  { id:"K109", brand:"kaleido", line:"Mecha", name:"Phantom Gray",      hex:"#606870",  barcode:"8436535951081" },
  { id:"K110", brand:"kaleido", line:"Mecha", name:"Forge Red",         hex:"#e02818",  barcode:"8436535951098" },
  { id:"K111", brand:"kaleido", line:"Mecha", name:"Rose Taupe",        hex:"#d09080",  barcode:"8436535951104" },
  { id:"K112", brand:"kaleido", line:"Mecha", name:"Chestnut Red",      hex:"#a01830",  barcode:"8436535951111" },
  { id:"K113", brand:"kaleido", line:"Mecha", name:"Azure Blue",        hex:"#2878d8",  barcode:"8436535951128" },
  { id:"K114", brand:"kaleido", line:"Mecha", name:"Dark Azure",        hex:"#1a50c0",  barcode:"8436535951135" },
  { id:"K115", brand:"kaleido", line:"Mecha", name:"Space Blue",        hex:"#182258",  barcode:"8436535951142" },
  { id:"K116", brand:"kaleido", line:"Mecha", name:"Dark Space Blue",   hex:"#10183a",  barcode:"8436535951159" },
  { id:"K117", brand:"kaleido", line:"Mecha", name:"Freedom Blue",      hex:"#1a50d0",  barcode:"8436535951166" },
  { id:"K118", brand:"kaleido", line:"Mecha", name:"Desert Rose",       hex:"#c88898",  barcode:"8436535951173" },
  { id:"K119", brand:"kaleido", line:"Mecha", name:"Armor White",       hex:"#e8eaf0",  barcode:"8436535951180" },
  { id:"K120", brand:"kaleido", line:"Mecha", name:"Armor Gray",        hex:"#a0a8b0",  barcode:"8436535951197" },
  { id:"K121", brand:"kaleido", line:"Mecha", name:"Armor Carbon",      hex:"#2a2a2c",  barcode:"8436535951203" },
  { id:"K122", brand:"kaleido", line:"Mecha", name:"Dark Coral",        hex:"#e03828",  barcode:"8436535951210" },
  { id:"K123", brand:"kaleido", line:"Mecha", name:"Sunset Orange",     hex:"#e89010",  barcode:"8436535951227" },
  { id:"K124", brand:"kaleido", line:"Mecha", name:"Artillery Green",   hex:"#5a7848",  barcode:"8436535951234" },
  // ── AUTO COLORS (solid) ───────────────────────────────────────────────────
  ...
  // ── METAL ─────────────────────────────────────────────────────────────────
  { id:"KM001", brand:"kaleido", line:"Metal", name:"Zirconium Black",  hex:"#3a3838",  barcode:"8436535952001" },
  { id:"KM002", brand:"kaleido", line:"Metal", name:"Gun Metal",        hex:"#504e50",  barcode:"8436535952018" },
  { id:"KM003", brand:"kaleido", line:"Metal", name:"Tungsten Steel",   hex:"#b8b8b8",  barcode:"8436535952025" },
  { id:"KM004", brand:"kaleido", line:"Metal", name:"Titanium Alloy",   hex:"#c0b8a8",  barcode:"8436535952032" },
  { id:"KM005", brand:"kaleido", line:"Metal", name:"Stainless Steel",  hex:"#c8c4b8",  barcode:"8436535952049" },
  { id:"KM006", brand:"kaleido", line:"Metal", name:"Silver",           hex:"#c89480",  barcode:"8436535952056" },
  { id:"KM007", brand:"kaleido", line:"Metal", name:"Aluminium",        hex:"#c8a840",  barcode:"8436535952063" },
  { id:"KM008", brand:"kaleido", line:"Metal", name:"Red Copper",       hex:"#c89030",  barcode:"8436535952070" },
  { id:"KM009", brand:"kaleido", line:"Metal", name:"Copper",           hex:"#c87020",  barcode:"8436535952087" },
  { id:"KM010", brand:"kaleido", line:"Metal", name:"Scorched Gold",    hex:"#b06818",  barcode:"06975834948344" },
  { id:"KM011", brand:"kaleido", line:"Metal", name:"Champagne Gold",   hex:"#c09030",  barcode:"8436535952100" },
  { id:"KM012", brand:"kaleido", line:"Metal", name:"Flashy Gold",      hex:"#d4880c",  barcode:"8436535952117" },
  // ── TRANSLUCENT ───────────────────────────────────────────────────────────
  ...
  { id:"72.001", brand:"vallejo", line:"Game Color", name:"Dead White",        hex:"#f2f2f2", barcode:"8429551720011" },
  ...
  { id:"72.006", brand:"vallejo", line:"Game Color", name:"Sun Yellow",        hex:"#f8bc00", barcode:"8429551720042" },
  ...
  { id:"72.010", brand:"vallejo", line:"Game Color", name:"Bloody Red",        hex:"#b01818", barcode:"8429551720035" },
  { id:"72.011", brand:"vallejo", line:"Game Color", name:"Gory Red",          hex:"#8a0e0e", barcode:"8429551720097" },
  ...
  { id:"72.014", brand:"vallejo", line:"Game Color", name:"Warlord Purple",    hex:"#5e1a8a", barcode:"8429551720103" },
  ...
  { id:"72.022", brand:"vallejo", line:"Game Color", name:"Ultramarine Blue",  hex:"#1a30a8", barcode:"8429551720059" },
  ...
  { id:"72.030", brand:"vallejo", line:"Game Color", name:"Goblin Green",      hex:"#2e8828", barcode:"8429551720066" },
  ...
  { id:"72.034", brand:"vallejo", line:"Game Color", name:"Bone White",        hex:"#e0d8b0", barcode:"8429551720080" },
  ...
  { id:"72.043", brand:"vallejo", line:"Game Color", name:"Beasty Brown",      hex:"#724420", barcode:"8429551720073" },
  ...
  { id:"72.050", brand:"vallejo", line:"Game Color", name:"Cold Grey",         hex:"#707e8e", barcode:"8429551720110" },
  { id:"72.051", brand:"vallejo", line:"Game Color", name:"Black",             hex:"#0d0d0d", barcode:"8429551720028" },
  ...
  { id:"70.951", brand:"vallejo", line:"Model Color", name:"White",            hex:"#f2f2f2",  barcode:"8429551700013" },
  { id:"70.919", brand:"vallejo", line:"Model Color", name:"Cold White",       hex:"#f0f4ff",  barcode:"" },
  { id:"70.918", brand:"vallejo", line:"Model Color", name:"Ivory",            hex:"#ede0b8",  barcode:"8429551700020" },
  { id:"70.820", brand:"vallejo", line:"Model Color", name:"Off White",        hex:"#ece8d8",  barcode:"" },
  { id:"70.950", brand:"vallejo", line:"Model Color", name:"Black",            hex:"#0d0d0d",  barcode:"8429551700037" },
  ...
  { id:"70.957", brand:"vallejo", line:"Model Color", name:"Flat Red",         hex:"#b81818",  barcode:"8429551700044" },
  { id:"70.926", brand:"vallejo", line:"Model Color", name:"Red",              hex:"#c82020",  barcode:"" },
  { id:"70.817", brand:"vallejo", line:"Model Color", name:"Scarlet",          hex:"#d81020",  barcode:"8429551700051" },
  ...
  { id:"70.965", brand:"vallejo", line:"Model Color", name:"Prussian Blue",    hex:"#182888",  barcode:"8429551700075" },
  ...
  { id:"70.968", brand:"vallejo", line:"Model Color", name:"Flat Green",       hex:"#2a7030",  barcode:"8429551700082" },
  ...
  { id:"70.978", brand:"vallejo", line:"Model Color", name:"Dark Yellow",      hex:"#c8a020",  barcode:"8429551700068" },
  { id:"70.977", brand:"vallejo", line:"Model Color", name:"Desert Yellow",    hex:"#c0a048",  barcode:"" },
  { id:"70.988", brand:"vallejo", line:"Model Color", name:"Khaki",            hex:"#c0a868",  barcode:"8429551700106" },
  ...
  { id:"70.995", brand:"vallejo", line:"Model Color", name:"German Grey",      hex:"#484840",  barcode:"8429551700099" },
...
function PaintSearch({allPaints,onSelect,brandFilter="all"}){
  ...
  const results=query.length<1?[]:paints.filter(p=>{
    ...
    return bOk&&(p.name.toLowerCase().includes(q)||p.id.toLowerCase().includes(q)||p.line.toLowerCase().includes(q)||(p.barcode&&p.barcode.includes(q)));
  }).slice(0,18);
...
function ManualBarcodeEntry({allPaints,onFound,onTeach,onAddNew,onAddCustom,addNewMode="shop"}){
  ...
  useEffect(()=>{
    ...
    const exactBC=paints.find(p=>p.barcode===clean);
    if(exactBC){setResult({found:true,paint:exactBC,code:clean});return;}
    if(clean.length>=4&&/^\d+$/.test(clean)){
      const partialBC=paints.find(p=>p.barcode&&p.barcode.includes(clean));
      if(partialBC){setResult({found:true,paint:partialBC,code:clean});return;}
    }
    const q=clean.toLowerCase();
    const nameMatch=paints.find(p=>p.name.toLowerCase().includes(q)||p.id.toLowerCase().includes(q));
    if(nameMatch){setResult({found:true,paint:nameMatch,code:clean});return;}
    // name search with no match — show "not found" if 3+ chars and not pure digits
    if(clean.length>=3&&!/^\d+$/.test(clean)) setResult({found:false,code:clean,isName:true});
    else if(clean.length>=8) setResult({found:false,code:clean});
    else setResult(null);
  },[val,paints.length]);
        ...
        <div style={{marginTop:6,border:`1px solid ${T.green}`,padding:"10px 12px",background:"rgba(0,204,102,.05)",borderRadius:10}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:10,marginTop:8}}>
            ...
            <div style={{flex:1}}>
              ...
              {result.paint.barcode&&<div style={{color:T.dim,fontSize:10,fontFamily:"monospace"}}>{result.paint.barcode}</div>}
            </div>
            <Btn onClick={()=>onFound(result.paint)} small>USE</Btn>
          </div>
        </div>
      )}
      {result&&!result.found&&(
        <div style={{marginTop:6,border:`1px solid ${T.yellow}`,borderRadius:10,padding:"10px 12px",background:"rgba(255,208,0,.05)"}}>
          {result.isName?(
            <>
              <Badge color={T.yellow}>NO MATCH FOUND</Badge>
              <div style={{color:T.dim,fontSize:11,margin:"6px 0"}}>
                No paint named <span style={{color:T.white,fontWeight:700}}>"{result.code}"</span> in database.
              </div>
              {onAddCustom&&(
                <Btn onClick={()=>onAddCustom(val.trim())} small full>+ ADD "{val.trim()}" AS CUSTOM PAINT</Btn>
              )}
            </>
          ):(
            <>
              <Badge color={T.yellow}>NOT IN DATABASE</Badge>
              <div style={{color:T.dim,fontSize:11,margin:"6px 0"}}>
                Barcode <span style={{fontFamily:"monospace",color:T.white}}>{result.code}</span> isn't linked.
              </div>
              {paints.length>0&&(
                <>
                  ...
                  <PaintSearch allPaints={paints} onSelect={p=>{if(onTeach) onTeach(result.code); onFound(p);}} brandFilter="all"/>
                </>
              )}
...
function BarcodeScanner({allPaints,onFound,onTeach,onClose,onAddNew,addNewMode="shop"}){
  ...
  useEffect(()=>{
    ...
    s.onload=()=>setReady(true); s.onerror=()=>setStatus("error");
  ...
  useEffect(()=>{
    ...
    async function start(){
      try{
        // Explicitly request camera permission - this triggers the browser popup
        const stream=await navigator.mediaDevices.getUserMedia({video:{facingMode:{ideal:"environment"}}});
        if(!active){stream.getTracks().forEach(t=>t.stop());return;}
        // Stop the stream — ZXing will open its own
        stream.getTracks().forEach(t=>t.stop());
        const Z=window.ZXing;
        if(!Z){setStatus("error");setCamError("Scanner library failed to load.");return;}
        const hints=new Map();
        ...
        const devices=await Z.BrowserMultiFormatReader.listVideoInputDevices();
        if(!devices||devices.length===0){setStatus("error");setCamError("No camera found.");return;}
        ...
        await reader.decodeFromVideoDevice(device.deviceId,videoRef.current,(result,err)=>{
          if(!active) return;
          if(result) { handleCode(result.getText()); reader.reset(); }
        });
      }catch(e){
        if(active){
          setStatus("error");
          setCamError(e?.name==="NotAllowedError"?"Camera permission denied — please allow camera access in your browser settings.":e?.message||"Camera error.");
        }
      }
    }
    start();
    return ()=>{
      active=false; readerRef.current?.reset();
  ...
  function handleCode(code){
    setScannedCode(code);
    const match=paints.find(p=>p.barcode===code);
    ...
    try{
      ...
      for(const maxW of sizes){
        ...
        try{
          ...
          hints.set(Z.DecodeHintType.TRY_HARDER,true);
          const reader=new Z.BrowserMultiFormatReader(hints);
          const result=await reader.decodeFromImageUrl(canvas.toDataURL("image/jpeg",.9));
          code=result.getText(); break;
        }catch(e){continue;}
      }
      if(code) handleCode(code); else setStatus("photo_fail");
    }catch(e){setStatus("photo_fail");}
  }

  function switchMode(m){
    readerRef.current?.reset();
    if(videoRef.current?.srcObject) videoRef.current.srcObject.getTracks().forEach(t=>t.stop());
    setMode(m); setStatus(m==="live"?"starting":"idle");
    setScannedCode(null); setFoundPaint(null);
  }

  const isResult=status==="found"||status==="unknown";

  return (
    <div style={{border:`1px solid ${T.border}`,background:"#0a0a0a",padding:12,borderRadius:10}}>
      {!isResult&&status!=="decoding"&&(
        <div style={{display:"flex",gap:0,marginBottom:10,border:`1px solid ${T.border}`}}>
          {[["live","LIVE SCAN"],["photo","PHOTO SCAN"]].map(([m,l])=>(
            <button key={m} onClick={()=>switchMode(m)}
              style={{flex:1,padding:"7px 0",border:"none",background:mode===m?T.orange:"transparent",
                color:mode===m?"#000":T.dim,fontWeight:900,fontSize:10,letterSpacing:1,cursor:"pointer",textTransform:"uppercase"}}>
              {l}
            </button>
          ))}
        </div>
      ...
      {mode==="live"&&(status==="starting"||status==="scanning")&&(
        <div style={{position:"relative",aspectRatio:"4/3",maxHeight:220,background:"#000",overflow:"hidden"}}>
          ...
          {status==="scanning"&&(
            <>
              <div style={{position:"absolute",left:"8%",right:"8%",top:"50%",height:2,
                ...
                animation:"scanline 1.6s ease-in-out infinite",boxShadow:`0 0 10px ${T.orange}`}}>
                <style>{`@keyframes scanline{0%,100%{transform:translateY(-40px);opacity:.4}50%{transform:translateY(40px);opacity:1}}`}</style>
              </div>
              {[["top","left"],["top","right"],["bottom","left"],["bottom","right"]].map(([v,h],i)=>(
                <div key={i} style={{position:"absolute",[v]:8,[h]:8,width:20,height:20,
                  [`border${v[0].toUpperCase()+v.slice(1)}`]:`3px solid ${T.orange}`,
                  [`border${h[0].toUpperCase()+h.slice(1)}`]:`3px solid ${T.orange}`}}/>
              ))}
              <div style={{position:"absolute",bottom:8,left:0,right:0,textAlign:"center",color:T.orange,fontSize:10,fontWeight:900,letterSpacing:2}}>AIM AT BARCODE</div>
            </>
          )}
          {status==="starting"&&<div style={{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",color:T.dim,fontSize:11,letterSpacing:2,textTransform:"uppercase"}}>INITIALISING...</div>}
        </div>
      )}

      {mode==="live"&&status==="error"&&(
        <div style={{padding:"16px 8px",textAlign:"center",border:`2px dashed ${T.border}`,borderRadius:12}}>
          <div style={{color:T.white,fontSize:13,fontWeight:700,letterSpacing:1,marginBottom:6}}>LIVE SCAN UNAVAILABLE</div>
          <div style={{color:T.dim,fontSize:11,marginBottom:12}}>{camError||"Camera could not be accessed."}</div>
          <Btn onClick={()=>switchMode("photo")} small>SWITCH TO PHOTO SCAN</Btn>
        </div>
      )}

      {mode==="photo"&&(status==="idle"||status==="starting")&&(
        <div style={{padding:"4px 0"}}>
          <div style={{color:T.orange,fontSize:10,fontWeight:900,letterSpacing:2,marginBottom:6,textTransform:"uppercase"}}>▐ TYPE BARCODE MANUALLY</div>
          <ManualBarcodeEntry allPaints={paints} onFound={p=>{onFound(p);onClose();}} onTeach={code=>{onTeach&&onTeach(code);onClose();}} onAddNew={onAddNew} addNewMode={addNewMode}/>
          <div style={{display:"flex",alignItems:"center",gap:8,margin:"10px 0 8px"}}>
            <div style={{flex:1,height:1,background:T.border}}/>
            <span style={{color:T.dimmer,fontSize:10,letterSpacing:2,textTransform:"uppercase"}}>OR</span>
            <div style={{flex:1,height:1,background:T.border}}/>
          </div>
          <div style={{color:T.orange,fontSize:10,fontWeight:900,letterSpacing:2,marginBottom:6,textTransform:"uppercase"}}>▐ SCAN FROM PHOTO</div>
          <input ref={imgInputRef} type="file" accept="image/*" capture="environment"
            onChange={e=>{if(e.target.files[0]) decodeFromImage(e.target.files[0]); e.target.value="";}} style={{display:"none"}}/>
          <button onClick={()=>imgInputRef.current?.click()}
            style={{width:"100%",background:T.bg,border:`1px solid ${T.border}`,color:T.dim,
              fontWeight:900,fontSize:11,letterSpacing:1,textTransform:"uppercase",padding:"9px 0",cursor:"pointer",marginBottom:4,borderRadius:10}}>
            TAKE PHOTO OF BARCODE
          </button>
          <input type="file" accept="image/*" onChange={e=>{if(e.target.files[0]) decodeFromImage(e.target.files[0]); e.target.value="";}} style={{display:"none"}} id="bc-file-pick"/>
          <label htmlFor="bc-file-pick" style={{display:"block",textAlign:"center",color:T.dimmer,fontSize:10,cursor:"pointer",textDecoration:"underline",letterSpacing:1,textTransform:"uppercase"}}>or choose from library</label>
        </div>
      )}
      ...
      {status==="decoding"&&(
        <div style={{padding:"20px 8px",textAlign:"center"}}>
          ...
          <div style={{color:T.dim,fontSize:11,marginTop:6}}>Analysing your photo</div>
        </div>
      )}
      ...
      {status==="found"&&foundPaint&&(
        <div style={{padding:8}}>
          <Badge color={T.green}>MATCH FOUND</Badge>
          <div style={{display:"flex",alignItems:"center",gap:10,margin:"10px 0",background:T.surface,padding:"10px 12px",border:`1px solid ${T.border}`}}>
            <div style={{width:36,height:36,background:foundPaint.hex,border:`1px solid ${T.border}`,flexShrink:0}}/>
            <div style={{flex:1}}>
              <div style={{color:T.white,fontSize:14,fontWeight:700}}>{foundPaint.name}</div>
              <div style={{color:T.dim,fontSize:11}}>{BRANDS[foundPaint.brand]?.name} · {foundPaint.id}</div>
            </div>
          </div>
          <div style={{display:"flex",gap:8}}>
            <GhostBtn onClick={onClose} color={T.dim}>Cancel</GhostBtn>
            <Btn onClick={()=>{onFound(foundPaint);onClose();}}>Use This Paint</Btn>
          </div>
        </div>
      )}
      ...
      {status==="unknown"&&(
        <div style={{padding:8}}>
          ...
          <div style={{color:T.dim,fontSize:11,fontFamily:"monospace",background:T.surface,padding:"8px 10px",margin:"10px 0",borderRadius:8,border:`1px solid ${T.border}`}}>{scannedCode}</div>

          {/* Option 1 — link to existing paint */}
          {paints.length>0&&(
            <>
              <div style={{color:T.dim,fontSize:11,fontWeight:700,letterSpacing:1,textTransform:"uppercase",marginBottom:6}}>Link to an existing paint:</div>
              <PaintSearch allPaints={paints} onSelect={p=>{if(onTeach) onTeach(scannedCode,p.id); onFound(p); onClose();}} brandFilter="all"/>
            </>
          )}

          {/* Option 2 — add as new custom item */}
          {onAddNew&&<AddNewItemForm onAddNew={(item)=>{onAddNew(item);onClose();}} barcode={scannedCode} mode={addNewMode}/>}

          <div style={{display:"flex",gap:8,marginTop:10}}>
            <GhostBtn onClick={()=>{setStatus(mode==="live"?"scanning":"idle");setScannedCode(null);}} color={T.dim}>RETRY</GhostBtn>
            <GhostBtn onClick={onClose} color={T.dim}>CANCEL</GhostBtn>
            {onTeach&&<Btn onClick={()=>{onTeach(scannedCode);onClose();}} color={T.yellow}>LINK LATER</Btn>}
          </div>
        </div>
      )}
    </div>
...
function PaintDetailSheet({p,barcodeMap,ownedIds,ownedMap,allPaints,labComponents,setLabComponents,
  ...
  return (
    <Sheet title={p.name} badge="PAINT" onClose={onClose}
      footer={<Btn onClick={()=>onSaveEdit(p,editName,editHex,editBC)} full>SAVE CHANGES</Btn>}
      toast={cartToast?(
...
function ToolDetailSheet({tool,ownedIds,ownedMap,setOwnedMap,setTools,tools,onClose,onAddToShop,onDelete,setLightbox,cartToast}){
  ...
  function saveChanges(){
    setTools(prev=>prev.map(t=>t.id!==tool.id?t:{...t,name:eName,brand:eBrand,type:eType,notes:eNotes,barcode:eBarcode,location:eLocation,images:eImages}));
    onClose();
  }
...
export default function PaintTracker(){
  ...
  const [ownedMap,setOwnedMap]=useState({"t1":1,"t2":2}); // paintId/toolId -> quantity (0 = not owned)
  const ownedIds=Object.keys(ownedMap).filter(id=>ownedMap[id]>0);
  const [projInfoEdit,setProjInfoEdit]=useState(false);
  const [lightbox,setLightbox]=useState(null); // {photos, index}

  // Compute allPaints with barcode overrides
  const allPaints=[...ALL_PAINTS,...customPaints].map(p=>{
    const bc=Object.entries(barcodeMap).find(([,id])=>id===p.id)?.[0];
    return bc?{...p,barcode:bc}:p;
  });

  function teachBarcode(paintId,barcode){ setBarcodeMap(m=>({...m,[barcode]:paintId})); }
  ...
  // ── Edit paint form ──
  const [ePtN,setEPtN]=useState(""); const [ePtBC,setEPtBC]=useState(""); const [ePtHex,setEPtHex]=useState(""); const [ePtScan,setEPtScan]=useState(false);
  // ── Add custom paint form ──
  const [nCtB,setNCtB]=useState("custom"); const [nCtL,setNCtL]=useState("Custom"); const [nCtN,setNCtN]=useState(""); const [nCtH,setNCtH]=useState("#888"); const [nCtC,setNCtC]=useState(""); const [nCtBC,setNCtBC]=useState(""); const [nCtSc,setNCtSc]=useState(false);
  // ── Library ──
  ...
  const [nTName,setNTName]=useState(""); const [nTBrand,setNTBrand]=useState(""); const [nTType,setNTType]=useState("Brush"); const [nTNotes,setNTNotes]=useState(""); const [nTOwned,setNTOwned]=useState(true); const [nTBarcode,setNTBarcode]=useState(""); const [nTScan,setNTScan]=useState(false);
  ...
  const [eTName,setETName]=useState(""); const [eTBrand,setETBrand]=useState(""); const [eTType,setETType]=useState("Brush"); const [eTNotes,setETNotes]=useState(""); const [eTOwned,setETOwned]=useState(true); const [eTBarcode,setETBarcode]=useState(""); const [eTScan,setETScan]=useState(false);
  ...
  function addTool(){
    ...
    const t={id:"t"+Date.now(),name:nTName,brand:nTBrand,type:nTType,notes:nTNotes,owned:nTOwned,barcode:nTBarcode.trim(),qty:nTOwned?1:0,
      images:nTImages,location:nTLocation,purchaseDate:nTPurchaseDate,receipt:nTReceipt,purchaseFrom:nTPurchaseFrom};
    setTools(prev=>[...prev,t]);
    if(nTOwned) setOwnedMap(m=>({...m,[t.id]:1}));
    setNTName("");setNTBrand("");setNTType("Brush");setNTNotes("");setNTOwned(true);setNTBarcode("");setNTScan(false);
  ...
  function openEditTool(tool){
    ...
    setETOwned(tool.owned);setETBarcode(tool.barcode||"");setETScan(false);
  ...
  function saveEditTool(){
    ...
    setTools(tools.map(t=>t.id!==editingTool.id?t:{...t,name:eTName,brand:eTBrand,type:eTType,notes:eTNotes,owned:eTOwned,
      barcode:eTBarcode.trim(),images:eTImages,location:eTLocation,purchaseDate:eTPurchaseDate,receipt:eTReceipt,purchaseFrom:eTPurchaseFrom}));
    setEditingTool(null);
  }
  ...
  const [nCnQty,setNCnQty]=useState(1); const [nCnMinQty,setNCnMinQty]=useState(2);
  ...
  const [eCnQty,setECnQty]=useState(1); const [eCnMinQty,setECnMinQty]=useState(2);
  ...
  function addConsumable(){
    ...
    const c={id:"con"+Date.now(),name:nCnName,brand:nCnBrand,type:nCnType,notes:nCnNotes,
      barcode:nCnBarcode.trim(),qty:nCnQty,minQty:nCnMinQty,
  ...
  function openEditCon(c){
    ...
    setECnBarcode(c.barcode||"");setECnScan(false);setECnQty(c.qty||0);setECnMinQty(c.minQty||2);
  ...
  function saveEditCon(){
    ...
    setConsumables(consumables.map(c=>c.id!==editingCon.id?c:{...c,name:eCnName,brand:eCnBrand,type:eCnType,
      notes:eCnNotes,barcode:eCnBarcode.trim(),qty:eCnQty,minQty:eCnMinQty,
  ...
  function addConsumableToShop(c){
    addShopItem(c.name,c.brand||"","Supplies",c.barcode||"","",1);
  }
  const [colScan,setColScan]=useState(false); const [colTeach,setColTeach]=useState(null);
  // ── Shopping list ──
  ...
  const SHOP_CATS=["Paint","Brush","Airbrush","Palette Knife","Primer","Varnish","Masking Tape","Tools","Supplies","Other"];
  function addShopItem(name,brand,category,barcode,notes,qty){
    const n=name||nSName; if(!n.trim()) return;
    setShopItems(prev=>[...prev,{id:"s"+Date.now(),name:n,brand:brand||nSBrand,category:category||nSCat,barcode:barcode||nSBarcode,notes:notes||nSNotes,qty:qty||nSQty,ordered:false,done:false}]);
  ...
  function addPaintToShop(paint){
    ...
    setAddShopQty(1);setAddShopNotes("");
    setLibToast({name:paint.name,hex:paint.hex});
    setTimeout(()=>setLibToast(null),2500);
  }
  function addToolToShop(tool){ setConfirmAddToShop({name:tool.name,brand:tool.brand||"",category:tool.type,barcode:tool.barcode||"",hex:null}); setAddShopQty(1); setAddShopNotes(""); }
  function confirmAddShopItem(){
    if(!confirmAddToShop) return;
    const itemName=confirmAddToShop.name;
    setShopItems(prev=>[...prev,{id:"s"+Date.now(),...confirmAddToShop,qty:addShopQty,notes:addShopNotes,ordered:false,done:false}]);
  ...
  function addCustomPaint(){
    if(!nCtN.trim()) return;
    const p={id:"c"+Date.now(),brand:nCtB,line:nCtL,name:nCtN,hex:nCtH,code:nCtC};
    setCustomPaints(prev=>[...prev,p]);
    if(nCtBC.trim()) setBarcodeMap(m=>({...m,[nCtBC.trim()]:p.id}));
    setOwnedMap(m=>({...m,[p.id]:1}));
    setNCtN("");setNCtH("#888");setNCtC("");setNCtBC("");setNCtSc(false); setShowAddPaint(false);
  }
    ...
    <div style={{minHeight:"100vh",background:T.bg,fontFamily:T.font,color:T.white,position:"relative"}}>
      ...
      <div style={{background:T.bg,padding:"10px 16px",
        ...
        <div style={{position:"absolute",top:-60,right:-60,width:250,height:250,
          ...
          background:"radial-gradient(circle, rgba(212,245,74,0.15) 0%, transparent 65%)",
          filter:"blur(40px)",zIndex:0}}/>
        <div style={{display:"flex",alignItems:"center",gap:10,position:"relative",zIndex:1}}>
          <div style={{background:T.orange,width:48,height:32,clipPath:"polygon(10px 0%,100% 0%,calc(100% - 10px) 100%,0% 100%)"}}/>
          <div>
            <div style={{fontWeight:900,fontSize:17,letterSpacing:-1,lineHeight:1}}>PAINT<span style={{color:T.orange}}>FORGE</span></div>
            <div style={{color:T.dim,fontSize:8,letterSpacing:3,textTransform:"uppercase"}}>Colour Mix Tracker</div>
          </div>
        </div>
        <div style={{color:T.orange,fontWeight:900,fontSize:11,letterSpacing:2,textTransform:"uppercase",position:"relative",zIndex:1}}>
            ...
            <div style={{marginBottom:14}}>
              ...
              {shopScan&&(
                <div style={{marginTop:10}}>
                  <BarcodeScanner
                    allPaints={allPaints}
                    onFound={p=>{addPaintToShop(p);setShopScan(false);}}
                    onTeach={code=>{setShopTeach(code);setShopScan(false);}}
      ...
      {showAddCol&&(
        <Sheet title="Add to Collection" badge="COLLECT" onClose={()=>{setShowAddCol(false);setColScan(false);setColTeach(null);}}>
          ...
          <ManualBarcodeEntry allPaints={allPaints.filter(p=>!ownedIds.includes(p.id))} onFound={p=>{setOwnedMap(m=>({...m,[p.id]:(m[p.id]||0)+1}));setShowAddCol(false);}} onTeach={code=>setColTeach(code)}
          ...
          {colScan&&(
            <div style={{marginTop:10}}>
              <BarcodeScanner allPaints={allPaints}
                onFound={p=>{setOwnedMap(m=>({...m,[p.id]:(m[p.id]||0)+1}));setColScan(false);setShowAddCol(false);}}
                onTeach={(code,paintId)=>{
                  if(paintId){
                    // Barcode was linked directly from the scanner's search — save immediately
                    teachBarcode(paintId,code);
                    setOwnedMap(m=>({...m,[paintId]:(m[paintId]||0)+1}));
                    setColScan(false);setShowAddCol(false);
                  } else {
                    // No paint selected yet — show the link UI
      ...
      {showAddPaint&&(
        <Sheet title="Add Custom Paint" badge="CUSTOM" onClose={()=>{setShowAddPaint(false);setNCtSc(false);}}
          ...
          <FieldLabel>Barcode (optional)</FieldLabel>
          <div style={{display:"flex",gap:6,marginBottom:nCtSc?10:14}}>
      ...
      {/* ADD TOOL MODAL */}
      {showAddTool&&(
        <Sheet title="Add Tool" badge="TOOL" onClose={()=>{setShowAddTool(false);setNTScan(false);}}
      ...
      {editingTool&&(
        <Sheet title="Edit Tool" badge="EDIT" onClose={()=>{setEditingTool(null);setETScan(false);}}
          ...
          <FieldLabel>Date purchased</FieldLabel>
          <input type="date" value={eTPurchaseDate} onChange={e=>setETPurchaseDate(e.target.value)}
            style={{width:"100%",maxWidth:"100%",boxSizing:"border-box",background:"#0a0a0a",border:`1px solid ${T.border}`,
              padding:"6px 10px",color:T.white,fontSize:12,fontFamily:T.font,outline:"none",marginBottom:10,colorScheme:"dark",display:"block"}}/>
          <FieldLabel>Photos of tool</FieldLabel>
      ...
      {showAddCon&&(
        <Sheet title="Add Supply Item" badge="SUPPLIES" onClose={()=>{setShowAddCon(false);setNCnScan(false);}}
          footer={<>
      ...
      {showAddShop&&(
        <Sheet title="Add to Shopping List" badge="SHOP" onClose={()=>{setShowAddShop(false);setNSScan(false);setShopSearchQ("");setShopCustomMode(false);}}>
      ...
      {confirmAddToShop&&(
        <Sheet title="Add to Shopping List" badge="SHOP" onClose={()=>setConfirmAddToShop(null)}
...
function BarcodeScanner({allPaints,onFound,onTeach,onClose,onAddNew,addNewMode="shop"}){
  ...
  useEffect(()=>{
    ...
    async function start(){
      try{
        ...
        const devices=await Z.BrowserMultiFormatReader.listVideoInputDevices();
        const device=devices.find(d=>/back|rear|environment/i.test(d.label))||devices[devices.length-1];
        if(!device){setStatus("error");return;}
        setStatus("scanning");
  ...
  return (
    <div style={{border:`1px solid ${T.border}`,background:"#0a0a0a",padding:12,borderRadius:10}}>
      ...
      {mode==="live"&&status==="error"&&(
        <div style={{padding:"16px 8px",textAlign:"center",border:`2px dashed ${T.border}`,borderRadius:12}}>
          <div style={{color:T.white,fontSize:13,fontWeight:700,letterSpacing:1,marginBottom:6}}>LIVE SCAN BLOCKED</div>
          <div style={{color:T.dim,fontSize:11,marginBottom:12}}>Try Photo Scan instead — works in preview!</div>
          <Btn onClick={()=>switchMode("photo")} small>SWITCH TO PHOTO SCAN</Btn>
        </div>
      )}
      ...
      {status==="unknown"&&(
        <div style={{padding:8}}>
          ...
          {paints.length>0&&(
            <>
              <div style={{color:T.dim,fontSize:11,fontWeight:700,letterSpacing:1,textTransform:"uppercase",marginBottom:6}}>Link to an existing paint:</div>
              <PaintSearch allPaints={paints} onSelect={p=>{if(onTeach) onTeach(scannedCode); onFound(p); onClose();}} brandFilter="all"/>
            </>
          )}
        ...
        <Sheet title="Add to Collection" badge="COLLECT" onClose={()=>{setShowAddCol(false);setColScan(false);setColTeach(null);}}>
          ...
          {colScan&&(
            <div style={{marginTop:10}}>
              <BarcodeScanner allPaints={allPaints}
                onFound={p=>{setOwnedMap(m=>({...m,[p.id]:(m[p.id]||0)+1}));setColScan(false);setShowAddCol(false);}}
                onTeach={code=>{setColTeach(code);setColScan(false);}}
                onClose={()=>setColScan(false)}
                onAddNew={({name,brand,line,code,hex,barcode:bc})=>{
                  const p={id:"c"+Date.now(),brand,line,name,hex,code};
                  setCustomPaints(prev=>[...prev,p]);
