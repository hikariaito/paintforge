...
function BarcodeScanner({allPaints,onFound,onTeach,onClose,onAddNew,addNewMode="shop"}){
  ...
  async function startLiveScan(){
    ...
    try{
      ...
      // Load ZBar WASM (works on iOS Safari unlike BarcodeDetector)
      if(!window.ZBarWasm){
      ...
      setCamError(e?.name==="NotAllowedError"
        ?"Camera permission denied — please allow camera in Settings > Safari."
