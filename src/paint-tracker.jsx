...
async function sbGet(table,uid){
  try{
    ...
    console.log(`sbGet ${table}:`,r.status,data?.length??data);
    return r.ok?data:[];
  }catch(e){console.error(`sbGet ${table} error:`,e);return [];}
}
async function sbUpsert(table,rows){
  ...
  try{
    ...
    console.log(`sbUpsert ${table}:`,r.status,text.substring(0,100));
  }catch(e){console.error(`sbUpsert ${table} error:`,e);}
}
